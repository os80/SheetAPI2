...
Рекомендую разместить код библиотеки непосредственно в код вашего скрипта - тогда подсказки будут работать. Для работы тредует подключенную библиотеку "Google Sheets API"
